...
const ComponentLayout = (props: Props) => {
    ...
    return (
        <>
            <div
                className={`bg-gray-700 shadow rounded-xl mb-4 ${props.containerClasses ? props.containerClasses : ''}`}
                key={props.title}
            >
                <div className="flex flex-col items-center justify-between p-4 bordray-700er bg-g md:flex-row rounded-xl">
