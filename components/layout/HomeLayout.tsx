...
const HomeLayout: FC = ({ children }) => {
    return (
        <>
            ...
            <div className="relative overflow-hidden bg-gray-700 h-scrreen">
                <div className="h-full mx-auto max-w-7xl">
                    <div className="relative h-full pb-8 bg-gray-700 sm:pb-16 md:pb-20 lg:w-full lg:pb-28 xl:pb-32">
